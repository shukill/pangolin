...
import 'package:pangolin/src/screens/Graphichome/graphichome.dart';
import 'package:pangolin/src/screens/welcome/components/welcome_button.dart';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          WelcomeButton(
            tapEvent: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => GraphicHomeScreen()));
            },
          )
        ],
      ),
